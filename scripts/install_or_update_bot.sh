...
main_menu() {
    while true; do
        log "BLUE" "🤖 Telegram Publisher Bot"
        log "BLUE" "========================"
        log "BLUE" "1. ⬆️ Обновить из репозитория"
        log "BLUE" "2. 📝 Создать или редактировать .env файл"
        log "BLUE" "3. 🚀 Собрать и запустить контейнер бота"
        log "BLUE" "4. ⏹️ Остановить и удалить контейнер бота"
        log "BLUE" "5. 📊 Показать логи (все)"
        log "BLUE" "6. ❌ Показать логи ошибок"
        log "BLUE" "7. 🔄 Перезапустить бота"
        log "BLUE" "8. 🧹 Очистить старые логи и бэкапы"
        log "BLUE" "0. 🚪 Выйти"
        ...
        case "$choice" in
            ...
            4)
                ...
                ;;
            5)
                # TODO: Implement show logs (all)
                log "YELLOW" "⚠️ Функция показа логов (все) еще не реализована."
                ;;
            6)
                # TODO: Implement show error logs
                log "YELLOW" "⚠️ Функция показа логов ошибок еще не реализована."
                ;;
            7)
